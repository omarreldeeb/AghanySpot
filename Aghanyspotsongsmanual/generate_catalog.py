...
output_json = "/Users/omariko/Desktop/Aghanyspotsongsmanual/songs.json"

# Detailed metadata lookup table
METADATA_MAP = {
    # Amr Diab
    ...
    "btmanna ansak": {"title_ar": "بتمنى أساك", "artist_ar": "شيرين", "artist_en": "Sherine", "era": "2020s", "difficulty": "Medium"},
...
for song_file in song_files:
    ...
    # Extract artist and song title parts
    if " - " in clean_name:
...
print(f"✓ Generated catalog for {len(catalog)} songs at {output_json}")
